...
<body>
    ...
    <div class="container text-center">
        ...
        <p class="fs-4">Fill the form for add a new Category.</p>
        <hr>
    </div>
    ...
    <div class="container text-center">
        <form action="" method="post">
            ...
            <br>
            <div class="input-group">
                <input class="form-control" type="url" id="img_url" name="img_url" placeholder="Image Url" required>
            </div>
            <br>
            <div class="input-group">
            ...
            <br>
            <input class="btn btn-success" name="submit_cat" type="submit" value="Submit">
        </form>
    </div>
